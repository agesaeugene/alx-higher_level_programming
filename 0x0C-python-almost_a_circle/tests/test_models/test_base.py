#!/usr/bin/python3
"""
Unittest for base.py are defined and behaviour for different base classes are tested
"""
...
class TestBase_instantiation(unittest.TestCase):
    """Unit tests to verify that the Base class is instantiated"""
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """Unit tests for the Base class's save_to_file_csv function."""
